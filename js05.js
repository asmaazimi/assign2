...
function createLightbox() {
   ...
   function createOverlay() {
      ...
      let favoriteImage = document.getElementById(overlayImage.src);
      ...
      favoriteButton.onclick = function() {
         let favoriteImage = document.getElementById(overlayImage.src);
         if (favorites.children.length <= 5 && favoriteImage == null){
               let favoriteImage = overlayImage.cloneNode("true");
               favoriteImage.id = overlayImage.src;
               favorites.appendChild(favoriteImage);
               favoriteButton.innerHTML = "Remove from favorites";
          } else if(favoriteImage != null){
               favorites.removeChild(favoriteImage);
               favoriteButton.innerHTML = "Add to favorites";
         } else {
            window.alert("Maximum favorites reached. Delete one to add more.");
         }
      }
